...
function MixingBowl({ items, onRemove, onUpdateVolume, totalVolume }) {
  ...
  return (
    <div className="flex gap-4 h-full">
      <div
        ref={setNodeRef}
        className={`flex-1 min-h-[300px] max-h-[600px] overflow-y-auto border-2 border-dashed rounded-2xl p-4 transition-all duration-300 ${isOver ? 'border-indigo-500 bg-indigo-50 scale-[1.02]' : 'border-gray-300 bg-gray-50/50'}`}
      >
        {items.length === 0 ? (
